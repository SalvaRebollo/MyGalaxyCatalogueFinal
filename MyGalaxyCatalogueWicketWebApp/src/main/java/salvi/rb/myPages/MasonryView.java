...
public class MasonryView extends WebPage {
    private static final long serialVersionUID = 1L;

    public MasonryView(final PageParameters parameters) throws SQLException, ClassNotFoundException {
        super(parameters);
    ...
    protected void onInitialize() {
        ...
        Label title = new Label("title", "Productos y Servicios Timeline");
        add(title);
        ...
        List<PanelMasonryProduct> listaPanelMasonryProduct = ListOfObjectToListPanelMasonryProduct(listaDatosEnObjeto);

        System.out.println("\n----------------------------\nlistaPanelMasonryProduct:\n" + listaPanelMasonryProduct);


        add(new ListView<PanelMasonryProduct>("productsPanels", listaPanelMasonryProduct) {
            @Override
            protected void populateItem(ListItem<PanelMasonryProduct> item) {
                item.add(new PanelMasonryProduct(
                        "panelX",
    ...
    public List<ProductUserTotalInfoPojo> BbddConection() {
        ...
        try {
            ...
            while (listProductsJoinUsersRS.next()) {
                ...
                //productUserTotalInfoPojoRabbit.setFotoPerfilUser("https://via.placeholder.com/150");
