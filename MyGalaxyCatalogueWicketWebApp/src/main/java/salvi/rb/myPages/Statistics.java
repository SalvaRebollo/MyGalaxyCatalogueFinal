...
public class Statistics extends WebPage {
    ...
    public Statistics(final PageParameters parameters) throws SQLException, ClassNotFoundException {
        super(parameters);
    ...
    protected void onInitialize() {
        ...
        Label title = new Label("title", "Productos registrados en los últimos 10 días");
        add(title);
