...
public class PanelCardProduct extends Panel {
     ...
     */
    public PanelCardProduct(String id, Model<String> imgProduct, Model<String> tituloProduct, Model<String> fotoPerfilUser, Model<String> nomUser, Model<String> descProduct, Model<String> precioProduct, Model<String> estadoProduct, Model<String> categProduct, Model<String> emailUser, Model<String> metContactoUser) {
        super(id);
        ...
        Image image = new Image("imagenProducto", "");
        image.add(new AttributeModifier("src", imgProduct));
        image.add(new AttributeModifier("title", tituloProduct));
        add(image);
